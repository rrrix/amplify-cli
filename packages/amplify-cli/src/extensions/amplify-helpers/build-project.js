...
async function buildProject(context, category, resourceName, filteredResources) {
  ...
  await providersBuild(context, category, resourceName, filteredResources);
...
async function providersBuild(context, category, resourceName, filteredResources) {
  ...
  for (let i = 0; i < providers.length; i += 1) {
    ...
    providerPromises.push(providerModule.buildProject(context, resourceDefiniton));
  }
