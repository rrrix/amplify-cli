...
## [2.0.6](https://github.com/rapticore/amplify-cli/compare/amplify-category-storage@1.31.0...amplify-category-storage@2.0.6) (2019-12-05)


### Bug Fixes

* give ddb trigger different policy name from lambda execution ([#2801](https://github.com/rapticore/amplify-cli/issues/2801)) ([b97a7db](https://github.com/rapticore/amplify-cli/commit/b97a7db7e856d9bd6a5568b8b7a4ea7ef27c57f9))
* **amplify-category-storage:** validate max length of bucket name ([ace68a9](https://github.com/rapticore/amplify-cli/commit/ace68a9a41adf29e924a5eee2f7970d041c24feb))
* randomize role-names and bucket-name for auth and storage category ([#2709](https://github.com/rapticore/amplify-cli/issues/2709)) ([fe0e979](https://github.com/rapticore/amplify-cli/commit/fe0e979812bd3142a56a62bf15444cbb3dbbb6bb))
